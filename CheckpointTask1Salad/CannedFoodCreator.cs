...
{
    public class CannedFoodCreator : IFabricComponents
    {
        ...
        {
            return new CannedFood() { Calories = calories, Carbohydrates = carbohydrates, Fats = fats, Name = name, Proteins = proteins, Taste = taste, Vitamins = vitamins, Weight = weight };
        }

...
{
    public class CheesesCreator : IFabricComponents
    {
        ...
        {
            return new Cheeses() { Calories = calories, Carbohydrates = carbohydrates, Fats = fats, Name = name, Proteins = proteins, Taste = taste, Vitamins = vitamins, Weight = weight };
        }

...
{
    public class GreensCreator : IFabricComponents
    {
        ...
        {
            return new Greens() { Calories = calories, Carbohydrates = carbohydrates, Fats = fats, Name = name, Proteins = proteins, Taste = taste, Vitamins = vitamins, Weight = weight };
        }

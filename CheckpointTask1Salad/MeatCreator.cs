...
{
    public class MeatCreator : IFabricComponents
    {
        ...
        {
            return new Meat() { Calories = calories, Carbohydrates = carbohydrates, Fats = fats, Name = name, Proteins = proteins, Taste = taste, Vitamins = vitamins, Weight = weight };
        }

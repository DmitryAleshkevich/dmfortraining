...
{
    public class SpicesCreator : IFabricComponents
    {
        ...
        {
            return new Spices() { Calories = calories, Carbohydrates = carbohydrates, Fats = fats, Name = name, Proteins = proteins, Taste = taste, Vitamins = vitamins, Weight = weight };
        }
